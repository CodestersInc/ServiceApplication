...
public class TransportListAdapter extends RecyclerView.Adapter<TransportListAdapter.MyViewHolder> {
    ...
    List<TransportItem> data;
    private Context context;

    private int expandedPosition = -1;

    public TransportListAdapter(Context context, List<TransportItem> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(layout.transport_item_list, parent, false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TransportItem transportItem = data.get(holder.getPosition());
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        TransportItem transportItem = data.get(position);
        holder.title.setText(transportItem.TransportTitle);
        holder.icon.setImageResource(transportItem.TransportIconId);
