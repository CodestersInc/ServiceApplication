...
public class MedicalListAdapter extends RecyclerView.Adapter<MedicalListAdapter.MyViewHolder> {
    ...
    List<MedicalItem> data;
    private Context context;

    private int expandedPosition = -1;

    public MedicalListAdapter(Context context, List<MedicalItem> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(layout.medical_item_list, parent, false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MedicalItem foodItem = data.get(holder.getPosition());
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        MedicalItem medicalItem = data.get(position);
        holder.title.setText(medicalItem.MedicalTitle);
        holder.icon.setImageResource(medicalItem.MedicalIconId);
